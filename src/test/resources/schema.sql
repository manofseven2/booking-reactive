...
insert into PUBLIC.RESERVATION ( COST, SUCCESSFUL, TRANSACTION_NUMBER, USER_ID) VALUES ( 301, false, 'TR0001', select id from public.user where email ='user@gmail.com' );
insert into PUBLIC.RESERVATION ( COST, SUCCESSFUL, TRANSACTION_NUMBER, USER_ID) VALUES ( 350, false, 'TR0002', select id from public.user where email ='user@gmail.com' );
insert into PUBLIC.RESERVATION ( COST, SUCCESSFUL, TRANSACTION_NUMBER, USER_ID) VALUES ( 200, true, 'TR0003', select id from public.user where email ='user@gmail.com' );